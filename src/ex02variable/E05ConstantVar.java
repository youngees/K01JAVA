...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 선언시 전체를 대문자로 선언하고, 연결되는 단어가 있는경우 _(언더바)를
		 사용한다.
		...
		/*
		 가위 바위 보 게임을 제작하기 위해 개발자는 아래와같이 설정하였다.
		 가위: 1 , 바위:2 , 보 :3
		 */
		final int SCISSOR = 1;
		final int ROCK = 2;
		...
		int computer, user;
		/*
		 1과3은 개발자 본인만 알수있는 내용이므로. 가독성이 떨어지는 코드로
		 작성되었다. 만약 다른 개발자가 해당 코드를 본다면 확인절차를 거쳐야
		 할 것이다.
		 */
		computer = 1;
		user = 3;
		...
		/*
		 PAPER와 같은 단어는 누가 보더라도 이해할 수 있으므로 가독성이 높은
		 명시적인 코드가 되었다.
		 */
		computer = SCISSOR;
		user = PAPER;
