...
/*
 break문 : 반복문이나 switch문에서 주로 사용되며 블럭내에서 break문을 만나면
           해당블럭을 탈출한다. 만약 중첩된 반복문이라면 가장 가까운 블럭하나만
           탈출하게 된다.
 
 continue문: 반복문에서 continue를 만나면 처음으로 돌아가서 조건을 확인한다. 
             continue아래 문장은 실행되지 않는다.
 */
	...
	public static void main(String[] args) {
		...
		while(true) {
			/*
			 ...
			 같이 사용해야한다. 그렇지않으면 Unreachable code에러가 발생한다.
			 */
			i++;
