...
public class E07ForEachBasic
{
	...
	public static void main(String[] args)
	{
		...
		/*
		참조형태로 각 요소를 읽어와서 변수 b에 할당하는 형식이므로 아래 
		증가연산자를 통해 증가하는 것은 실제 배열에 적용되지 않는다.
		해당 for문 내에서만 증가하게된다.(실제 배열에 영향을 미치지 x)
		 */
