...
public class E01StringBasic
{
	...
	public static void main(String[] args)
	{
		...
		*/
		...
		/*
		 String 클래스의 객체생성방법1
		    : new를 이용한다. new를 사용하면 동일한 문자열이라도 항상 새로운 메모리를
		    생성하게 된다.
		*/
		...
		단순한 참조값(주소값)에 대한 비교를 하게된다.
		2개의 객체가 생성되므로 참조주소는 다르다는 결과를 출력하게 된다.
		*/
		if(str1==str2) {
		...
		/*
		 equals()메서드
		    : Object클래스로부터 상속받은 메서드로 실제 저장된 문자열을 비교하도록
		    만들어진 메서드이다. 즉 아래는 객체에 저장된 실제 문자열에 대한 비교가 이루어진다.
		 */
		if(str1.equals(str2)) {
		...
		/*
		String클래스의 객체 생성 방법2 
		    : "(더블쿼테이션)을 사용한다. 이 경우 내용이 동일하다면 같은 주소를 
		    사용하게 된다. 즉 새로운 객체를 생성하지 않는다. 
		    따라서 주로 String 객체는 이와같이 생성한다.
		 */
		String str3 = "KOSMO";
		String str4 = "KOSMO";
