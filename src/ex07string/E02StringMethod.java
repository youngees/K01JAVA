...
public class E02StringMethod
{
	...
	public static void main(String[] args)
	{
		...
		//문자열에서 문자 하나를 뽑아 비교하므로 싱글쿼테이션을 사용해야한다.
		...
		/*
		5. concat()
		    : 두개의 문자열을 연결할 때 사용한다. +기호와 동일한 역할을 한다.
		 */
		...
		/*
		시나리오] 해당 문자열이 이메일형식인지 검사하는 프로그램을 작성하시오.
		...
		작성하시오.
		 */
		System.out.println("### indexOf()로 성별확인하기 ###");
		...
		/*
		11. lastIndexOf() : 사용법은 indexOf()와 동일하나 문자열의 뒤에서부터
		                   찾는 것이 다르다.
		 */
		...
		System.out.println("lastIndexOf:"+str1.lastIndexOf("a"));//14(뒤에있는 a의 인덱스)
		...
		System.out.println("java를 kosomo로 변경하기");
		System.out.println(str1.replace("java","kosomo")); //KOSMO로 변경됨
		
		/*
		13. split () : 문자열을 구분자를 통해 분리해서 String타입의 배열로 반환
		          한다. 해당 구분자가 없는 경우에는 크기가 1인 배열로 반환된다.
		 */
		...
		/*
		14. substring() : 시작인덱스와 끝인덱스 사이의 문자열을 잘라서
		                  반환해준다.
		...
		/*
		시나리오] 다음파일명에서 확장자를 잘라내는 프로그램을 작성하시오.
		...
		/*
		15.codePointAt(인덱스) : 문자열의 특정 인덱스의 문자를 찾은 후 아스키코드
		(유니코드)를 반환한다.
		 */
